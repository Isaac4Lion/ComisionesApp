...
const CommissionModal = ({
  ...
  const [form, setForm] = useState({
    abono_comision: commissionValue,
    fecha_abono: "",
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/comisiones/${detalleLote.id}`,
        requestedOptions
      );
  ...
  useEffect(() => {
    setCommissionValue(Number(detalleLote.valor_comision)/2);
  }, [detalleLote]);
            ...
            <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              <div className="sm:flex sm:items-start px-2">
                ...
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  <DialogTitle
                    as="h3"
                    className="text-base mb-5 leading-6 text-gray-900"
                  >
                    <span className="font-bold">Registro de Comisión</span> -
                    CLIENTE: {detalleLote.nombre_cliente}
                  </DialogTitle>
                  <div className="mt-2">
