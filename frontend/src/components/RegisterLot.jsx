...
import { InformationCircleIcon, PlusCircleIcon, MinusCircleIcon } from '@heroicons/react/24/outline';

export default function RegisterLot({ openModalRegister, setOpenModalRegister, listarLotes }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:3000/api/lotes/registrar', requestedOptions)
  ...
  return (
    <Dialog open={openModalRegister} onClose={setOpenModalRegister} className="relative z-10">
      <DialogBackdrop
            ...
            <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              <div className="sm:flex sm:items-start px-2">
                ...
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  <DialogTitle as="h3" className="text-base font-bold mx-5 mt-1 leading-6 text-gray-900">
                    Lote Nuevo
                  </DialogTitle>
                  <div className="mt-2">
                    <form id='lotRegisterForm' className="w-full" onSubmit={handleSubmit}>
