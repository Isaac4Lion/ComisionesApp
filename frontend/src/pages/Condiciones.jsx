...
import CondicionesForm from "../components/CondicionesForm";
...
export default function Condiciones() {
  ...
  const listarCondiciones = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/condiciones`,{headers:{Authorization: `Bearer ${token}`}});
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div className="mt-2">
                      <form className="w-full">
                        <div className="">
                          ¿Estás seguro de eliminar esta condición? Esta acción
